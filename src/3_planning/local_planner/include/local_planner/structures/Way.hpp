...
class Way {
 private:
   ...
   * @param[in] D 
   */
  static bool segmentsIntersect(const local_planner::Point &A, const local_planner::Point &B, const local_planner::Point &C, const local_planner::Point &D);
 ...
 public:
   ...
   */
  bool closesLoopWith(const Edge &e, const local_planner::Point *lastPosInTrace = nullptr) const;
   ...
   */
  std::vector<local_planner::Point> getPath() const;
