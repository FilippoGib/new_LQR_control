...
class Node {
 private:
   ...
   */
  mutable local_planner::Point point_;

  /**
   * @brief Cone point in global coordinates.
   */
  const local_planner::Point pointGlobal_;
 ...
 public:
   ...
   */
  const local_planner::Point &point() const;

  /**
   * @brief Returns the point in global coordinates.
   */
  const local_planner::Point &pointGlobal() const;
   ...
   * @param[in] p
   */
  double distSq(const local_planner::Point &p) const;
