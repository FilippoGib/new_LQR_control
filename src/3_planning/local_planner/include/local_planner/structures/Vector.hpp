 ...
 */
class Vector : public local_planner::Point {
 public:
  /**
   ...
   * @param[in] b 
   */
  Vector(const local_planner::Point &a, const local_planner::Point &b);
   ...
   * @param[in] dir 
   */
  static bool pointBehind(const local_planner::Point &futPos, const local_planner::Point &actPos, const Vector &dir);
